...
class Daemon:
    ...
    def run_backend(self):
        ...
        while (not self._stop) and (not self.ssis_monitor.abortRequested()):
            ...
            elif xbmc.getCondVisibility("[Window.IsActive(videos) + !Window.IsActive(filebrowser)] + [Container.Content(directors) | Container.Content(actors) | Container.Content(genres) | Container.Content(years) | Container.Content(studios) | Container.Content(countries) | Container.Content(tags)]"):
